...
class Trader {
    public :
        virtual void effectuerTransactions(const BourseVecteur& boursevecteur, const Portefeuille& portefeuille,const date &date)=0;
};

class TraderAleatoire : public Trader {
    public :
        void effectuerTransactions(const BourseVecteur& boursevecteur, Portefeuille &portefeuille,const date &date)
        {
           int i=0;
           int s=rand()%3;
           while(i<100 && s!=2 )
